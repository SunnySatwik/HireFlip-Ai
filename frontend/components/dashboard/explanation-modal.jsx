...
export function ExplanationModal({ candidate, onClose, showAcceptButton = true, onApproveRecommendation }) {
  ...
  const generateAiExplanation = async () => {
    ...
    try {
      ...
      setAiExplanation('Unable to generate AI insight at this time. Please refer to the manual breakdown below.')
    } finally {
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium">Generated by Gemini AI</p>
                  </div>
                </div>
              ...
              {!isGenerating && aiExplanation && (
                <div className="mt-4 flex items-center gap-2 text-[9px] font-black uppercase tracking-widest text-purple-500/60">
